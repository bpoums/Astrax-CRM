 ...
 */
export const Route = createFileRoute("/_authenticated/cx/transfer")({
  beforeLoad: () => {
    throw redirect({ to: "/cx", search: { tab: "transfer" }, replace: true });
  },
  head: () => ({ meta: [{ title: "Transfer Pipeline | ASTRAX" }] }),
});
